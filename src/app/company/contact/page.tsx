...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Use EmailJS library directly
      const result = await emailjs.send(
        "service_3duh8kk",//Service_ID
        "template_b08xi1i",//Template_ID
        {
          from_name: formState.name,
          from_email: formState.email,
          phone: formState.phone,   
          message: formState.message,
          subject: formState.subject || "New contact from website",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              >
                ...
                <p className="text-lg text-gray-700 mb-8">
                  Have questions or want to learn more about our AI solutions?
                ...
                <div className="hidden lg:block">
                  <img
                    ...
                    onError={(e) => {
                      e.currentTarget.src =
                        "https://via.placeholder.com/500x400/f5f5f5/FE6623?text=Contact+Us";
                    }}
                  />
                </div>
              </motion.div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Frequently Asked{" "}
                <span className="heading-orange">Questions</span>
              </h2>
              ...
              {[
                {
                  ...
                  answer:
                    "DeeCogs combines cutting-edge AI technology with deep industry expertise to create solutions that are not only technically advanced but also tailored to specific business challenges. Our approach focuses on delivering measurable results and seamless integration with existing systems.",
                },
                {
                  question: "How can I request a demo of your products?",
                  answer:
                    "You can request a demo by filling out the contact form above, specifying which product you're interested in, or by emailing us directly at info@deecogs.com. Our team will get back to you to schedule a personalized demonstration.",
                },
                {
                  question: "Do you offer customized AI solutions?",
                  answer:
                    "Yes, we specialize in creating customized AI solutions tailored to your specific business needs. We begin with a thorough consultation to understand your challenges, then develop a solution that integrates seamlessly with your existing systems and processes.",
                },
                {
                  question: "What industries do you serve?",
                  answer:
                    "We serve a wide range of industries including healthcare, finance, manufacturing, retail, and more. Our AI solutions are adaptable and can be customized to address specific challenges across various sectors.",
                },
              ].map((faq, index) => (
                <motion.div
                  key={index}

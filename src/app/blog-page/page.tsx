        ...
        <div className="min-h-screen bg-white">
          ...
          <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative">
            ...
            <article className="prose max-w-full mx-auto lg:space-y-2">
              ...
              <h2 id="struggles" className="text-3xl font-semibold mb-6 mt-20 text-gray-900  scroll-mt-32">
              ...
              <h2 id="core-problems" className="text-3xl font-semibold mb-6 text-gray-900 mt-[40px] scroll-mt-32">
              ...
              <p className="text-gray-800 leading-8 max-w-[850px] text-[14px] text-justify mb-20">

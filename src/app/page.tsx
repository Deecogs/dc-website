        ...
        <header className="absolute z-10 w-100 start-0 right-0 top-0">
          <div className="container mx-auto">
            ...
            >
              ...
              <Navbar.Toggle />
              <Navbar.Collapse>
                <ul className="flex flex-col p-4 xl:p-0 text-[16px] xl:text-[18px] mt-0 border-t border-[#ffffffb3] bg-black xl:bg-transparent space-y-3 xl:space-y-0   xl:flex-row xl:space-x-8 rtl:space-x-reverse xl:mt-0 xl:border-0 ">
                  <li>
                    <Link
                      href="#"
                      className="text-white font-normal  tracking-[
-0.54px]"
                      aria-current="page"
                    >
                      Company
...
-0.54px]"
                  ...
                  <li>
                    <Link
                      href="#"
                      className="text-white font-normal text-[16px]  xl:text-[22px] border py-[8px] px-[36px] rounded-[24px] border-[#fe6623]"
                    >
                      {" "}
                      Login
                    </Link>
      ...
      <main>
        <section className="hero-bg pt-[100px]  md:pt-[133px] xl:p-0 xl:h-screen">
          <div className="container px-[10px] flex flex-col  justify-end h-full mx-auto">
            <div className="flex flex-row">
              <div className="basis-full ">
                <h1 className="text-[26px] md:text-[40px] lg:text-[80px]  mb-[0] font-normal leading-normal text-[#ffffffb3]">
                  Intelligent Systems
                </h1>
                <div className="text-[26px] md:text-[40px] lg:text-[80px]  mb-[26px] xl:mb-[48px] font-normal leading-normal text-[#ffffffb3]">
                  <div className="flex items-center flex-wrap flex-row ">
                    ...
                    <div>
                      <span className="px-[15px] xl:px-[24px]">For</span>
                    </div>
                    ...
                    <div className="max-w-[220px] relative z-0 md:max-w-[400px] xl:max-w-[700px]">
                      <Slider {...settings}>
                        ...
                        <div>
                          <span className="text-[#1c77cb]">Encoding</span>
                        </div>
                        <div>
                          <span className="text-[#1c77cb]">
                            Financial Analysis
                ...
                <div className="flex flex-wrap flex-col xl:flex-row xl:items-center">
                  <div>
                    <p className="max-w-[581px] mb-[15px] xl:mb-[0px] text-[#ffffffe6] text-[16px] xl:text-[22px] leading-normal">
                  ...
                  <div className="h-[92px] hidden xl:block ms-[58px] me-[64px] border border-[#ffffff]"></div>

                  <div className="flex-shrink-0">
                    <Button
                      className="bg-[#fe6623e3] !outline-0  hover:!bg-[#fe6623e3] !shadow-none !text-[16px] xl:!text-[22px] border border-[#fe6623] hover:!bottom-[#fff] leading-none rounded-[32px] py-[8px] px-[21px] inline-block text-[#ffffffe6]"
            ...
            <div className="flex  flex-wrap justify-between mt-[60px] xl:mt-[97px] border-t border-[#ffffffb3] pb-[13px] lg:pt-[13px] lg:pb-[38px] gap-[5px] lg:gap-[10px]">
              <div>
                <span className="text-[#AAAAAD]  text-[12px] md:text-[24px]">
                  LLMs
                </span>
              </div>
              <div>
        ...
        <section className="our-collaborators-sec py-[56px] lg:py-[136px]">
          <div className="container px-[10px] mx-auto">
            <div className="flex justify-center flex-row flex-wrap">
              <div className="basis-full lg:basis-7/12">
                <div className="text-center">
                  <h2 className="text-[26px] lg:text-[48px] mb-[18px] lg:mb-[26px] text-[#505050] font-normal">
                    Our Collaborators
                  </h2>
                  <p className="text-[18px] lg:text-[22px] mb-[30px] lg:mb-[55px] text-[#000000bf] font-normal">
                    ...
                    <div className="flex justify-between items-center  flex-wrap flex-row">
                      <div className="flex-1 text-center md:flex-none">
                        <img
                          ...
                          className="max-w-[100px] inline-block  md:max-w-[128px]"
                          alt=""
                        />
                      </div>
                      <div className="flex-1 text-center lg:flex-none">
                        <img
                          ...
                          className="max-w-full inline-block h-[90px] md:h-[192px]"
                          alt=""
                        />
                      </div>
                      <div className="flex-1 text-center lg:flex-none">
                        <img
                          ...
                          className="max-w-full inline-block h-[80px] md:h-[95px]"
                          alt=""
                        />
                      </div>
                    </div>
          ...
          <div className="container px-[10px] mx-auto">
            <div className="flex flex-wrap flex-row">
              <div className="basis-full lg:basis-6/12">
                <div className="bg-[#FFFFFFAD] border py-[30px] lg:py-[62px] px-[30px] lg:px-[42px] rounded-[24px]">
                  <div>
                    <span className="bg-[#1316310D] rounded-[31px] py-[8px] px-[16px] text-[13px] text-[#000]">
                      Who we are
                    </span>
                    <h2 className="text-[26px] lg:text-[46px] pt-[22px]  lg:pt-[27px] pb-[31px] leading-normal text-[#000]">
                      We specialize in{" "}
                      <span className="heading-orange">Cutting-Edge </span>{" "}
                      <span className="heading-orange block">AI Solutions</span>
                    </h2>
                  </div>
                  <p className="text-[16px] lg:text-[22px] mb-[57px] leading-normal text-[#000000BF]">
                  ...
                  <a
                    className="bg-[#FE6623E3] text-[18px] lg:text-[22px] border border-[#FE6623] rounded-[24px] py-[8px] px-[21px] inline-block text-[#ffffffe6]"
                    href="#"
                  >
                    Book a Demo
                  </a>
        ...
        <section className="delivering-ai-solutions py-[56px] lg:py-[160px]">
          <div className="container px-[10px] mx-auto">
            <div>
              <span className="bg-[#1316310D] rounded-[31px] py-[8px] px-[16px] text-[13px] text-[#000]">
                Solutions
              </span>
              <div className="flex mb-[36px] mt-[22px] lg:mt-[53px] flex-row flex-wrap items-start">
                <div className="flex-grow">
                  <h2 className="text-[26px] lg:text-[48px]  text-[#000000CC] leading-normal font-normal">
                    <span className="block">
                      Delivering AI solutions that are resilient and
                    </span>
                    <span className="heading-orange">Uncompromising</span> in
              ...
              <Tabs
                className="slider-tab-bar ,mb-[30px] lg:mb-[73px] flex-nowrap  whitespace-nowrap  overflow-x-auto"
                aria-label="Pills"
                variant="pills"
              >
                <Tabs.Item className="custom-tab" active title="Vision Tech">
                  <Swiper
                    slidesPerGroup={2}
                    ...
                    <SwiperSlide>
                      <div className="slider-column relative rounded-[24px]  overflow-hidden">
                        <img
                          ...
                          className="max-w-full w-full h-[350px] md:h-[654px] object-cover object-center"
                          alt=""
                        />
                        <div className="absolute w-full bottom-0 left-0 right-0 p-[14px]">
                          <div className="bg-[#292c334d] blur-bg items-center rounded-[16px]  lg:py-[28px] p-[15px] lg:px-[36px] flex justify-between ">
                            <div className="grow">
                              <h3 className="text-white text-[18px] lg:text-[32px] font-bold">
                                Data Parsing
                              </h3>
                              <p className="text-[#CED4D7] w-full lg:max-w-[494px] whitespace-normal text-[16px] lg:text-[22px] font-normal">
                            ...
                            <div className="shrink-0">
                              <Link href="/coming-soon">
                                <img
                                  ...
                                  className="max-w-full w-[45px] lg:w-[54px]"
                                />
                              </Link>
                            </div>
                          </div>
                        ...
                        <div className="absolute w-full bottom-0 left-0 right-0 p-[14px]">
                          <div className="bg-[#292c334d] blur-bg items-center rounded-[16px]  lg:py-[28px] p-[15px] lg:px-[36px] flex justify-between ">
                            <div className="grow">
                              ...
                              <p className="text-[#CED4D7] w-full lg:max-w-[494px] whitespace-normal text-[16px] lg:text-[22px] font-normal">
                              Harnessing the Power of multimodal LLMs for advanced data processing, seamlessly integrating...
                              </p>
                            </div>
                            <div className="shrink-0">
                              <Link href="/coming-soon">
                      ...
                      <div className="slider-column relative rounded-[24px]  overflow-hidden">
                        ...
                        <div className="absolute w-full bottom-0 left-0 right-0 p-[14px]">
                          <div className="bg-[#292c334d] blur-bg items-center rounded-[16px]  lg:py-[28px] p-[15px] lg:px-[36px] flex justify-between ">
                            <div className="grow">
                              <h3 className="text-white text-[18px] lg:text-[32px] font-bold">
                              Canse <span className="inline-block text-[#CED4D7] font-normal">(Cancer Prognostic Tool)</span> 
                              </h3>
                              <p className="text-[#CED4D7] w-full lg:max-w-[494px] whitespace-normal text-[16px] lg:text-[22px] font-normal">
                              Transforming oncology with AI-powered cancer prediction, enabling early detection, personalized...
                              </p>
                            </div>
                            <div className="shrink-0">
                              <Link href="/coming-soon">
                        ...
                        <div className="absolute w-full bottom-0 left-0 right-0 p-[14px]">
                          <div className="bg-[#292c334d] blur-bg items-center rounded-[16px]  lg:py-[28px] p-[15px] lg:px-[36px] flex justify-between ">
                            <div className="grow">
                              ...
                              <p className="text-[#CED4D7] w-full lg:max-w-[494px] whitespace-normal text-[16px] lg:text-[22px] font-normal">
                              Deciphering medical data processing with AI, ensuring accurate analysis, seamless integration...
                              </p>
                            </div>
                            <div className="shrink-0">
                              <Link href="/coming-soon">
        ...
        <section className="ensuring-sec py-[56px]  lg:pt-[72px] lg:pb-[72px] bg-[#FE662314]">
          <div className="container px-[10px] mx-auto">
            <div className="text-center">
              <span className="bg-[#1316310D] rounded-[31px] py-[8px] px-[16px] text-[13px] text-[#000]">
                Privacy & Security
              </span>
              <h2 className="text-[26px] lg:text-[48px] mt-[22px] lg:mt-[39px]  text-[#000000CC] leading-normal font-normal">
                <span>Ensuring</span>{" "}
                <span className="heading-orange">End-to-End</span> Encryption
              </h2>
            </div>
            <div className="grid-cols-1 grid lg:grid-cols-2 place-items-stretch mt-[30px] lg:mt-[107px] gap-[30px] lg:gap-[32px]  xl:gap-[64px]">
              <div className="bg-[#FE66232E] items-center flex flex-row  rounded-[24px] py-[20px] xl:py-[48px] px-[20px] xl:px-[65px]">
                <div className="shrink-0">
                  <svg
                    width="63"
                    height="80"
                ...
                <div className="grow ps-[22px] xl:ps-[36px]">
                  <h3 className="text-[#0E1A36] mb-[11px] text-[22px] xl:text-[32px] leading-normal">
                    Data Encryption & Storage
                  </h3>
                  <p className="text-[#000000BF] text-[16px]  xl:text-[20px] leading-normal">
        ...
        <section className="driving-growth-sec py-[56px] lg:py-[192px]">
          <div className="container px-[10px] mx-auto">
              ...
              <div className="basis-full lg:basis-6/12">
                <div>
                  <div>
                    ...
                    <h2 className="text-[26px] lg:text-[46px]  pt-[27px] pb-[31px] leading-normal text-[#000]">
                      Driving Growth and Shaping a{/* */}{" "}
                      <span className="heading-orange">Smarter Future </span>{" "}
                      for Our Clients
                    </h2>
                  </div>
                  <p className="text-[18px] lg:text-[22px] mb-[30px] lg:mb-[57px] leading-normal text-[#000000BF]">
                    From enhancing decision-making with advanced analytics to
                    streamlining operations through intelligent automation.
                  </p>
                </div>
                <div className="columns-1 lg:columns-2  gap-[15px] lg:gap-[32px]">
                  <div className="mb-[20px] lg:mb-[56px]">
                    <div className="flex flex-row">
                      <div className="shrink-0 ">
                        <img
                          src="/image/v-1.png"
                          className="h-[36px] mt-[18px]"
                          alt=""
                        />
                      </div>
                      <div className="grow ps-[20px]">
                        <span className="heading-orange-two mb-[8px] text-[32px] leading-normal font-bold">
                          +10
                        </span>
                  ...
                  <div className="mb-[20px] lg:mb-[56px] place-self-center">
                    <div className="flex  flex-row">
                      <div className="shrink-0 ">
                        <img
                          src="/image/v-4.png"
                ...
                <a
                  className="bg-[#FE6623E3]  mt-[30px] lg:mt-[56px] text-[18px] lg:text-[22px] border border-[#FE6623] rounded-[24px] py-[8px] px-[21px] inline-block text-[#ffffffe6]"
                  href="#"
                >
                  Book a Demo
                </a>
              </div>
              <div className="basis-full mt-[30px] lg:mt-0 lg:basis-6/12">
                <img
          ...
          <div className="container  mx-auto">
            <div className="text-center">
              <div>
                ...
                <h2 className="text-[26px] lg:text-[48px] mb-[28px] mt-[30px] lg:mt-[39px]  text-[#000000CC] leading-normal font-normal">
                  <span>Explore the</span>{" "}
                  <span className="heading-orange">Smart Note-Tab</span>
                </h2>
                <p className="text-[#707070] text-[18px] lg:text-[28px] leading-normal">
        ...
        <section className="the-challenges py-[56px]  lg:py-[183px]">
          <div className="container px-[10px] mx-auto">
            <div>
              <span className="bg-[#1316310D] rounded-[31px] py-[8px] px-[16px] text-[13px] text-[#000]">
                Challenges
              ...
              <div className="flex mb-[20px] lg:mb-[75px] lg:items-center mt-[26px] lg:mt-[53px] flex-col lg:flex-row flex-wrap items-start">
                <div className="grow">
                  <h2 className="text-[26px] lg:text-[48px]  text-[#000000CC] leading-normal font-normal">
                ...
                <div className="shrink-0">
                  <div className=" lg:max-w-[444px] lg:ms-auto lg:text-center">
                    <span className="text-[18px] lg:text-[22px] block text-[#0000007D] leading-normal">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-[15px] lg:gap-x-[43px] gap-y-[30px] lg:gap-y-[53px] place-items-stretch">
              <div className="py-[20px] md:py-[42px] px-[20]  md:px-[42px] border rounded-[24px] border-[#292C330F]">
                <h3 className="text-[#000000D9] leading-normal  font-normal mb-[15px] md:mb-[30px] text-[22px] md:text-[28px]">
                  Scaling Operations Efficiently
                </h3>
                <p className="text-[#000000BF] max-w-[363px] text-[16px] md:text-[20px] mb-[26px] md:mb-[50px] font-normal">
              ...
              <div className="py-[20px] md:py-[42px] px-[20]  md:px-[42px] border rounded-[24px] border-[#292C330F]">
                ...
                <p className="text-[#000000BF]  max-w-[363px] text-[20px] mb-[50px] font-normal">
        ...
        <section className="py-[56px] lg:py-[166px] latest-insights">
          <div className="container px-[10px] mx-auto">
            <div className="text-center">
              ...
              <h2 className="text-[26px] lg:text-[48px] mt-[30px] lg:mt-[39px]  text-[#000000CC] leading-normal font-normal">
                <span>Latest</span>{" "}
                <span className="heading-orange">Insights</span>
              </h2>
            </div>
            <div className="grid mt-[30px] lg:mt-[100px] lg:px-[60px] lg:grid-cols-2 lg:gap-x-[41px] gap-y-[15px] place-items-stretch ">
              <div>
                <div className="relative rounded-[24px] overflow-hidden">
                  ...
                  <div className="absolute w-full bottom-0 left-0 right-0 p-[14px]">
                    <div className="bg-[#292c334d] blur-bg items-center rounded-[16px] py-[15px] lg:py-[28px] px-[15px] lg:px-[36px] flex justify-between flex-wrap">
                      <div className="flex-grow">
                        <span className="text-[16px] text-[#92919C] mb-[3px]">
                          13th December 2024 | Blog
                        </span>
                        <h3 className="text-white text-[18px]  lg:text-[32px] font-normal">
            ...
            <div className="text-center mt-[30px] lg:mt-[64px]">
              <Link
                href="#"
                className="hover:bg-[#fe6623e3] text-[18px] lg:text-[22px] border border-[#fe6623] rounded-[32px] py-[8px] px-[26px] inline-block text-[#fe6623] hover:text-[#ffffffe6] "
              >
                View more
              </Link>
            </div>
              ...
              <div className="pe-[15px]">
                <Link href="#">
                  <img
                    ...
                    className="max-w-[250px] lg:max-w-[468px] mb-[15px] lg:mb-[55px] block"
                    alt=""
                  />
                </Link>
          ...
          <div className="flex flex-wrap mt-[30px] lg:mt-[0px] mb-[30px] lg:mb-[80px] flex-row items-end justify-between  lg:pe-[150px]">
            <div className="basis-full pe-[15px] lg:basis-5/12">
              <div className="max-w-[556px]">
                <span className="text-[#0000008a] font-normal text-[26px] lg:text-[32px] ">
                  For Latest Insights
                </span>
                <h3 className="text-[#000000] font-normal text-[32px] lg:text-[48px]">
          ...
          <Modal.Body className="lg:px-[200px] lg:pb-[80px] relative">
            <div className="space-y-6 h-full flex items-center flex-wrap ">
              <div className="w-full">
                <h3 className="text-[#000] lg:max-w-[654px] text-[28px] lg:text-[56px] leading-normal">
                ...
                <form action="" className="!mt-[30px] lg:!mt-[80px]">
                  <div className="grid grid-cols-1 md:grid-cols-3 md:gap-y-[48px] gap-y-[20px] gap-x-[15px]  md:gap-x-[32px]">
                    ...
                    <div className="md:col-span-3">
                      <Button className="bg-[#fe6623e3] !outline-0  hover:!bg-[#fe6623e3] !shadow-none !text-[16px] xl:!text-[22px] border border-[#fe6623] hover:!bottom-[#fff] leading-none rounded-[32px] py-[8px] px-[62px] inline-block text-[#ffffffe6]">
            ...
            <div>
              <img src="/image/d-overlay.png" className="max-w-[360px] md:max-w-[400px] lg:max-w-[500px] xl:max-w-[700px] absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%]" alt="" />
            </div>
          </Modal.Body>
        </Modal>
      </Flowbite>

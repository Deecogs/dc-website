 ...
 * 
 * Features:
 * - Proper semantic structure with nav sections
...
const Footer = () => {
  ...
  // Social media links data with proper accessibility labels
  const socialLinks = [
    {
      href: "https://in.linkedin.com/company/deecogs",
      icon: "linkedin", 
      ariaLabel: "Follow DeeCogs on LinkedIn",
    },
    { 
      href: "https://x.com/Deecogs_ai", 
      icon: "twitter", 
      ariaLabel: "Follow DeeCogs on X (Twitter)",
    },
    { 
      href: "#", 
      icon: "youtube", 
      ariaLabel: "Subscribe to DeeCogs YouTube channel",
    },
    {
      href: "https://www.instagram.com/deecogs_/#",
      icon: "instagram",
      ariaLabel: "Follow DeeCogs on Instagram",
    },
  ];

  // Footer navigation data with proper structure and descriptions
  const footerNavigation = [
    {
      title: "Company",
      ariaLabel: "Company links",
      links: [
        { text: "About Us", href: "/company/about", description: "Learn about our mission and team" },
        { text: "Careers", href: "/company/careers", description: "Join our team" },
        { text: "Contact Us", href: "/company/contact", description: "Get in touch with us" },
        { text: "Trust Centre", href: "/security", description: "Our security and compliance" },
        { text: "Recognitions", href: "#", description: "Awards and achievements" },
      ],
    },
    {
      title: "Resources",
      ...
      links: [
        { text: "Case Studies", href: "#", description: "Customer success stories" },
        { text: "Publications", href: "#", description: "Research papers and articles" },
        { text: "Testimonials", href: "#", description: "What our clients say" },
        { text: "Blogs", href: "/blog", description: "Latest insights and articles" },
        { text: "Videos", href: "#", description: "Tutorials and demos" },
      ],
    },
    {
      title: "Products",
      ...
      links: [
        { text: "Docurate", href: "/products/docurate", description: "Document intelligence platform" },
        { text: "VisionTech", href: "#", description: "Computer vision solution" },
        { text: "Fusio", href: "#", description: "Multimodal integration platform" },
        { text: "Rae", href: "#", description: "Conversational AI assistant" },
        { text: "Notei", href: "#", description: "Medical note analysis tool" },
      ],
    },
    {
      title: "Solutions",
      ariaLabel: "Solution links",
      links: [
        { text: "Canse", href: "#", description: "Cancer prognostic tool" },
        { text: "Therai", href: "#", description: "Cancer prediction tool", suffix: "(Cancer Prognostic Tool)" },
        { text: "Excerli", href: "#", description: "Fitness analytics platform", suffix: "(Workout Platform)" },
      ],
    },
  ];
  ...
  return (
    <footer 
      className="bg-[url('/image/footer.jpg')] [padding-top:_clamp(88px,4vw,255px)] relative bg-cover bg-center bg-no-repeat"
      role="contentinfo"
    ...
    >
      ...
      <div className="container max-w-[85rem] mx-auto px-[10px] relative z-10">
        ...
        >
            ...
            <div className="pe-[15px]">
              ...
              >
                {socialLinks.map((social, index) => (
                  <motion.div
                    key={social.icon}
                    className={`px-[2px] lg:px-[6px] ${
                      index === 0 ? "ps-0" : ""
                    } ${index === socialLinks.length - 1 ? "pe-[0px]" : ""}`}
                    variants={fadeInUp}
                    whileHover={{ scale: 1.15, y: -3 }}
                    transition={{ type: "spring", stiffness: 400 }}
                  >
                    <Link
                      className="text-[#6D6F7F] hover:text-primary transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-[#f8f9fa] p-2 inline-block rounded-full"
                      href={social.href}
          ...
          <motion.div className="basis-full lg:basis-7/12" variants={fadeInUp}>
            <motion.div
            ...
            >
              {footerNavigation.map((column) => (
                ...
                >
                  <h2 
                    className="text-lg lg:text-xl font-bold mb-[15px] lg:mb-[36px] text-[#0000009c] relative"
                    id={`footer-heading-${column.title.toLowerCase()}`}
                  >
                    {column.title}
                    <motion.span
                  ...
                  <nav 
                    aria-labelledby={`footer-heading-${column.title.toLowerCase()}`}
                  >
                    <motion.ul
                    ...
                    >
                      {column.links.map((link) => (
                        ...
                        >
                          <Link
                            href={link.href}
                            className="text-[#707070] text-sm lg:text-base hover:text-primary transition-colors flex items-center focus:outline-none focus:text-primary focus:underline"
                            aria-label={link.description || link.text}
                          >
                            <motion.span
                            ...
                            <span>
                              {link.text}
                              {link.suffix && (
                                <span className="text-[10px] ml-1 text-[#707070]/80">
                                  {link.suffix}
                                </span>
                              )}
                            </span>
        ...
        <div className="flex flex-wrap mt-[30px] lg:mt-[0px] mb-[30px] lg:mb-[58px] flex-row items-end">
          <div className="basis-full pe-[15px] lg:basis-6/12">
            <div className="max-w-[556px]">
              ...
              <form className="mt-[20px] lg:mt-[40px]" aria-label="Newsletter subscription">
                <div className="w-full group relative">
                  ...
                  <button
                    type="submit"
                    className="absolute right-0 top-1/2 -translate-y-1/2 text-primary hover:text-[#FE6623E3] transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded-full p-2"
            ...
            <ul className="flex justify-center flex-wrap gap-4 md:gap-8">
              {["Legal", "Privacy", "Trust"].map((item, index) => (
                ...
                >
                  <Link
                    href="#"
                    className="text-[#292C33] text-[14px] hover:text-primary transition-colors relative group focus:outline-none focus:text-primary"

...
const EncryptionSection = () => {
  ...
  const securityFeatures = [
    {
      icon: (
        <svg className="h-12 w-12 text-primary" viewBox="0 0 63 80" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    {
      icon: (
        <svg className="h-12 w-12 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
    ...
    {
      icon: (
        <svg className="h-12 w-12 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        ...
        <div className="flex justify-center">
          <div className="basis-full md:basis-11/12">
            ...
            >
              ...
              <h2 className="text-4xl text-[#000000CC] leading-[1.3] font-normal">
                <span>Ensuring</span>{" "}

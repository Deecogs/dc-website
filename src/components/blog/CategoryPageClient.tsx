// src/components/blog/CategoryPageClient.tsx
"use client";
          ...
          <div className="container max-w-[90rem] mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-normal mb-6">
                <span className="heading-orange">{decodedCategory}</span> Articles
              </h1>
              <p className="text-lg text-gray-600 mb-8">
                Explore our latest insights and articles about {decodedCategory}.
              </p>
              <Link 
                href="/blog" 
